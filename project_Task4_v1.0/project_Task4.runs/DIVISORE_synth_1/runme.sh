...
HD_PWD='C:/Users/giann/Desktop/PROGETTO FINALE/versione 1 - tutto xilinx/project_Task4/project_Task4.runs/DIVISORE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIVISORE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIVISORE.tcl
