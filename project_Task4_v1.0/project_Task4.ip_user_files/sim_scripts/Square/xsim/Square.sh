...
#
# Generated by Vivado on Sun Jul 16 21:19:26 +0100 2017
...
# Script info
echo -e "Square.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot Square xil_defaultlib.Square -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Square -key {Behavioral:sim_1:Functional:Square} -tclbatch cmd.tcl -log simulate.log
}
