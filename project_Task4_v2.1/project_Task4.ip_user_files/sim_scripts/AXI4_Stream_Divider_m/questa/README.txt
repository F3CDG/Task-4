...
#
# Generated by export_simulation on Tue Jul 18 09:23:35 GMT 2017
#
################################################################################
...
switch to the './AXI4_Stream_Divider_m.sh' script.

./AXI4_Stream_Divider_m.sh -reset_run
...
./AXI4_Stream_Divider_m.sh -noclean_files

For more information on the script, please type './AXI4_Stream_Divider_m.sh -help'.
