...
HD_PWD='/home/daniele/Scrivania/Task4/project_Task4_v2.1.1/project_Task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task4_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task4_m.tcl
